...
export const __wbg_get_jstransferfeequote_is_registration_block: (a: number) => number;
export const __wbg_set_jstransferfeequote_is_registration_block: (a: number, b: number) => void;
...
export const __wbg_jswithdrawalinforesponse_free: (a: number, b: number) => void;
export const __wbg_get_jswithdrawalinforesponse_info: (a: number) => [number, number];
export const __wbg_set_jswithdrawalinforesponse_info: (a: number, b: number, c: number) => void;
export const get_withdrawal_info: (a: number, b: number, c: number, d: number) => any;
export const get_withdrawal_info_by_recipient: (a: number, b: number, c: number, d: number) => any;
export const get_mining_list: (a: number, b: number, c: number) => any;
export const __wbg_jsclaiminforesponse_free: (a: number, b: number) => void;
export const __wbg_get_jsclaiminforesponse_info: (a: number) => [number, number];
export const __wbg_set_jsclaiminforesponse_info: (a: number, b: number, c: number) => void;
export const __wbg_get_jsclaiminforesponse_cursor_response: (a: number) => number;
export const __wbg_set_jsclaiminforesponse_cursor_response: (a: number, b: number) => void;
export const get_claim_info: (a: number, b: number, c: number, d: number) => any;
...
export const __wbg_jstimestampcursor_free: (a: number, b: number) => void;
export const __wbg_get_jstimestampcursor_cursor: (a: number) => [number, bigint];
export const __wbg_set_jstimestampcursor_cursor: (a: number, b: number, c: bigint) => void;
export const __wbg_get_jstimestampcursor_order: (a: number) => [number, number];
export const __wbg_set_jstimestampcursor_order: (a: number, b: number, c: number) => void;
export const __wbg_get_jstimestampcursor_limit: (a: number) => number;
export const __wbg_set_jstimestampcursor_limit: (a: number, b: number) => void;
export const jstimestampcursor_new: (a: number, b: bigint, c: number, d: number, e: number) => number;
export const __wbg_jstimestampcursorresponse_free: (a: number, b: number) => void;
export const __wbg_get_jstimestampcursorresponse_has_more: (a: number) => number;
export const __wbg_set_jstimestampcursorresponse_has_more: (a: number, b: number) => void;
export const __wbg_get_jstimestampcursorresponse_total_count: (a: number) => number;
export const __wbg_set_jstimestampcursorresponse_total_count: (a: number, b: number) => void;
export const jstimestampcursorresponse_new: (a: number, b: bigint, c: number, d: number) => number;
...
export const __wbg_get_jstimestampcursorresponse_next_cursor: (a: number) => [number, bigint];
export const __wbg_set_jstimestampcursorresponse_next_cursor: (a: number, b: number, c: bigint) => void;
...
export const closure1862_externref_shim: (a: number, b: number, c: any) => void;
export const closure2183_externref_shim: (a: number, b: number, c: any, d: any) => void;
